 ...
 * @author usuario
 */
public class frmProgresoDatos extends javax.swing.JFrame {

    /**
     * Creates new form frmProgresoDatos
     */
    public frmProgresoDatos() {
        initComponents();
    }
    
    public frmProgresoDatos(String label) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cargando datos de prueba");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(33, 33, 33)
                .addComponent(lblSpinner, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmProgresoDatos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmProgresoDatos().setVisible(true);
            }
        });
    }
