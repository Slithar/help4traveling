...
public class Cliente extends Usuario {
    ...
    private HashMap<String, Reserva> reservasCliente;
    
    public Cliente(){
        super();
        imagenUsuario = new Imagen("../Logica/perfiles/perfil.PNG", this);
        reservasCliente = new HashMap<String, Reserva>();
        
    }
    
    public Cliente(String nickname, String nombre, String apellido, String email, LocalDate fechaNac, String rutaCliente, HashMap<String, Reserva> reservasCliente){
    ...
    public HashMap<String, Reserva> getReservasCliente() {
        return reservasCliente;
    }

    public void setReservasCliente(HashMap<String, Reserva> ReservasCliente) {
        this.reservasCliente = ReservasCliente;
    }
